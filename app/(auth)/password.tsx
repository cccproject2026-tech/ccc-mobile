                        ...
                        <View className="flex flex-1 gap-14">
                            ...
                            <View className="p-5 flex gap-8 border border-solid border-white/20 rounded-[10px] mx-5">
                                <View className="flex gap-4 py-8">
                                    <InputField keyboardType="phone-pad" label="Username (Auto populated) Email ID" boxClass="!max-h-[52px] !h-full" />
                                    {showOtp && (
                                        <OtpInputBox
                                    ...
                                    {!showOtp && (
                                        ...
                                        >
                                            <TouchableOpacity className="rounded-lg border border-solid border-[#A5AFC5] py-4 px-20 flex justify-center items-center"
                                                style={{ boxShadow: "0px 4px 8px 0px #00000040" }}
                                                onPress={() => setShowOtp(true)}>
                                                <Text className="font-semibold text-base leading-[19px] text-white" style={{ fontFamily: "AlbertBold" }}>
                                                    Verify Email ID
                                                </Text>
                                            </TouchableOpacity>
                                        </LinearGradient>
                                ...
                                <View className="flex gap-4">
                                    ...
                                    <InputField keyboardType="phone-pad" label="Create Password" boxClass="!max-h-[52px] !h-full mt-[26px]" />
                                    <InputField keyboardType="phone-pad" label="Confirm Password" boxClass="!max-h-[52px] !h-full" />
                                    <Button
                                        title="Submit"
                                        onPress={() => {
