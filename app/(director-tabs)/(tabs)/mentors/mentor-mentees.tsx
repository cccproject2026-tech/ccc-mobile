...
export default function MentorMentees() {
    ...
    const menuItems = [
        { icon: 'people-outline', label: 'Revitalization Roadmaps', onPress: router.push.bind(router, '/(director-tabs)/(tabs)/mentors/mentor-mentees') },
        { icon: 'person-add-outline', label: 'Assessments', onPress: router.push.bind(router, '/(director-tabs)/(tabs)/mentors/assign-mentee') },
        { icon: 'person-remove-outline', label: 'Assignments', onPress: router.push.bind(router, '/(director-tabs)/(tabs)/mentors/remove-mentee') },
                ...
                <View className="flex-1 pt-6">
                    ...
                    <View className="flex-row items-center justify-between px-4 pb-3 mb-4 border-b border-white/30">
                        ...
                        <View style={{ flexDirection: 'row', gap: 12 }}>
                            ...
                            <TouchableOpacity
                                onPress={() => router.push('/(director-tabs)/(tabs)/mentors/assign-mentee')}
                                style={{
                                    flexDirection: 'row',
                                    alignItems: 'center',
                                    gap: 4,
                            ...
                            <TouchableOpacity style={{ padding: 4 }} onPress={() => router.push(`/(director-tabs)/(tabs)/mentors/mentor-mentee-locations`)}>
