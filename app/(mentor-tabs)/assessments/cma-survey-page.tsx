...
export default function CmaSurvey() {
  ...
  const handleAssignTo = (a: Assessment) => {
    ...
    router.push({
      pathname: "/(mentor-tabs)/assessments-v2/assign-to" as any,
          ...
          >
            ...
            {!isMentor && (
              <Button
                ...
                onPress={() => {
                  router.push({
                    pathname: "/(mentor-tabs)/assessments/answer-question-page" as any,
            ...
            {canViewResponses && (
              <Button
                ...
                onPress={() => {
                  router.push({
                    pathname: "/(mentor-tabs)/assessments/answer-questions" as any,
                    params: {
