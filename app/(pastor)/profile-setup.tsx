...
export default function ProfileUpload() {
    const { setProfileComplete } = useOnboardingStore();
    ...
    // 🧠 Mock function for backend upload
    const mockBackendUpload = async (fileUri: string, type: "image" | "document") => {
        // TODO: Replace this with actual Supabase or API upload later
    ...
    const handleContinue = async () => {
        try {
            ...
            if (hasUploaded) {
                // Mock backend sync before completing profile
    ...
    return (
        ...
        >
            <View style={styles.scrollContainer}>
                <TopBar role="pastor" showUserName userName="John Ross" />
