...
const JOURNEY_STEPS = [
    {
        ...
        number: "01",
        title: "Set your mentoring rhythm",
        desc: "Learn a simple cadence for encouragement, prayer, and next steps.",
    },
    {
        icon: "people-outline" as const,
        number: "02",
        title: "Meet and guide your mentees",
        desc: "Connect regularly and offer practical, faith-based support.",
    },
    {
        icon: "leaf-outline" as const,
        number: "03",
        title: "Support action and reflection",
        desc: "Help mentees move forward in community impact and keep momentum.",
    },
];

export default function MentorJourneyStep2Screen() {
    ...
    const handleNext = useCallback(() => {
        router.push(
            `/(unauthenticated)/mentor-start-journey/step-3/${role || "mentor"}` as any
        );
    }, [router, role]);
    ...
    return (
        <>
            ...
            <LinearGradient
                ...
                style={[
                    styles.gradient,
                    { paddingTop: top || 44, paddingBottom: bottom || 24 },
                ]}
            >
                ...
                <View style={styles.content}>
                    <View style={styles.titleBlock}>
                        ...
                        <Text style={styles.titleLight}>Your mentorship journey is</Text>
