...
export default function MentorJourneyStep3Screen() {
                ...
                <View style={styles.content}>
                    ...
                    <View style={styles.quoteBlock}>
                        ...
                        <Text style={styles.quoteText}>
                            Keep mentoring with <Text style={styles.quoteHighlight}>steady care</Text>{" "}
                            as you support the people God places in your path.
                        </Text>
                        <Text style={styles.quoteSource}>— CCC Mentoring Promise</Text>
                    </View>
                    ...
                    <View style={styles.readyBlock}>
                        ...
                        <Text style={styles.readyTitle}>
                            Ready to begin your{" "}
                            <Text style={styles.readyTitleAccent}>first mentoring step</Text>?
                        </Text>
                        <Text style={styles.readyDesc}>
                            Whether you’re new or returning — your mentoring journey{" "}
                            starts here with clear next steps and simple rhythms for growth.
                        </Text>
                    </View>
                </View>
