            ...
            {showMentorSelection ? (
              ...
              <View style={{ minHeight: "90%" }}>
                    ...
                    {showDateTimeSelection ? (
                      ...
                      <View style={styles.stepContent}>
                        ...
                        <View style={styles.calendarContainer}>
                          <GradientCalendar
                            headerText="Choose an Available Date"
                            headerTextStyle={{ fontSize: getFontSize(16) }}
                ...
                <View style={styles.step2Footer}>
                  ...
                  <Pressable
                    style={[
                      styles.scheduleButton,
                      {
                        backgroundColor: "rgba(30, 54, 111, 1)",
                        borderWidth: 1,
                        borderColor: isStep2Valid ? "#fff" : "#FFFFFF50",
                      },
                    ]}
                  ...
                  >
                    <Text
                      style={[styles.scheduleButtonText, { color: "#FFFFFF" }]}
                    >
