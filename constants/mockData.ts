...
export const MENU_ITEMS: MenuItem[] = [
    ...
    { id: 'schedule', label: 'Schedule', icon: 'calendar-outline', route: '/(director)/(tabs)' },
    ...
    },
    {
        ...
        icon: 'person-outline',
        children: [
            { id: 'my-profile', label: 'My Profile', icon: icons.myProfile, iconType: 'image', route: '/(director)/(tabs)/profile' },
