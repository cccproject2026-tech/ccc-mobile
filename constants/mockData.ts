...
export const PastorMenuItems: MenuItem[] = [
    ...
    // },
    {
        ...
        iconType: 'image',
        route: '/(pastor-tabs)/(tabs)/roadmap',
    },
    {
        id: 'assessments',
        label: 'Assessments',
        ...
        iconType: 'image',
        route: '/(pastor-tabs)/(tabs)/assessments',
    },
    {
        id: 'progress',
        label: 'Progress',
        icon: icons.progress,
        iconType: 'image',
        route: '/(pastor-tabs)/(tabs)/progress/progress',
    },
    {
        id: 'appointments',
        label: 'Appointments',
        ...
        iconType: 'image',
        route: '/(pastor-tabs)/(tabs)/appointments',
    },
    {
        id: 'profile',
        label: 'Profile',
        ...
        children: [
            {
                ...
                iconType: 'image',
                route: '/(pastor-tabs)/(tabs)/profile',
            },
            {
                id: 'documents',
                label: 'Documents',
                icon: icons.document,
                iconType: 'image',
                route: '/(pastor-tabs)/(tabs)/profile/documents',
            },
            {
                id: 'assignments',
                label: 'Assignments',
            ...
            },
            {
                ...
                iconType: 'image',
                route: '/(pastor-tabs)/(tabs)/profile/grant',
            },
        ],
    },
    {
