...
6. Cycle of Evangelism & Discipleship`,
    ...
    "p1-sign-roadmap": {
      ...
      description:
        "12-Month Revitalization Roadmap for pastoral mentoring and church revitalization growth",
      status: "NOT_STARTED",
        ...
        fields: [
          {
            ...
            onPress: "NAVIGATE",
            navigateTo:
              "/(pastor-tabs)/(tabs)/assessments/survey-guidelines?assessmentId=assessment_002" as RelativePathString,
          },
        ],
      },
      meta: {
    ...
    "p1-gods-vision": {
      ...
      description:
        "View how you see your church as a Christ-formed place and develop a vision",
      status: "NOT_STARTED",
      comments: ["comment-1", "comment-2", "comment-3", "comment-4"],
      queries: ["query-1", "query-2"],
    ...
    "p1-calendar": {
      ...
      title: "Calendar",
      description:
        "Create a calendar that will complement your vision for the church",
      status: "NOT_STARTED",
      comments: ["comment-1", "comment-2", "comment-3", "comment-4"],
      queries: ["query-1", "query-2"],
    ...
    "p1-member-desciple": {
      ...
      description:
        "Select a church member who will support you on this journey",
      status: "NOT_STARTED",
      comments: ["comment-1", "comment-2", "comment-3", "comment-4"],
      queries: ["query-1", "query-2"],
    ...
    "p1-community-engagement": {
      ...
      description:
        "Choose a community engagement project that aligns with your church",
      status: "NOT_STARTED",
      comments: ["comment-1", "comment-2", "comment-3", "comment-4"],
      queries: ["query-1", "query-2"],
    ...
    "p2-mou-with-ngos": {
      ...
      description:
        "Complete a community engagement project with the Member/Disciple and share the stories of Gods work",
      status: "NOT_STARTED",
      comments: ["comment-1", "comment-2", "comment-3", "comment-4"],
      queries: ["query-1", "query-2"],
        ...
        fields: [
          {
            ...
            placeholder:
              "Enter the name of the attendance tracker system information here...",
          },
        ],
        submitLabel: "Submit",
      },
    ...
    "p2-secret-guest": {
      ...
      title: "Secret Guest",
      description:
        'Process the "secret guest" visit with your church and incorporate findings into your welcome team strategy',
      status: "NOT_STARTED",
      comments: ["comment-1", "comment-2", "comment-3", "comment-4"],
      queries: ["query-1", "query-2"],
    ...
    "p2-share-your-vision": {
      ...
      description:
        "Make an effort to continually share your vision with the church",
      status: "NOT_STARTED",
      comments: ["comment-1", "comment-2", "comment-3", "comment-4"],
      queries: ["query-1", "query-2"],
    ...
    "p2-preaching-calendar": {
      ...
      description:
        "Coordinate a preaching calendar for the year that focuses on a growing relationship with Christ and with each ministry leader",
      status: "NOT_STARTED",
      comments: ["comment-1", "comment-2", "comment-3", "comment-4"],
      queries: ["query-1", "query-2"],
    ...
    "p2-proclamation-event-team": {
      ...
      description:
        "Recruit a team in charge of a proclamation event that shares the christian gospel with various audiences by creating a welcoming environment to explore the community and connect their faith",
      status: "NOT_STARTED",
      comments: ["comment-1", "comment-2", "comment-3", "comment-4"],
      queries: ["query-1", "query-2"],
    ...
    "p3-inactive-member-visitation": {
      ...
      description:
        "Model and train church leadership in inactive member pastoral visitation.",
      status: "NOT_STARTED",
      comments: ["comment-1", "comment-2", "comment-3", "comment-4"],
      queries: ["query-1", "query-2"],
    ...
    "p3-revitalization-plan": {
      ...
      description:
        "Share and celebrate you revitalization plan wins with your congregation.",
      status: "NOT_STARTED",
      comments: ["comment-1", "comment-2", "comment-3", "comment-4"],
      queries: ["query-1", "query-2"],
    ...
    "p3-strategic-plan": {
      ...
      description:
        "Review your church’s 3-year strategic plan and make necessary course corrections.",
      status: "NOT_STARTED",
      comments: ["comment-1", "comment-2", "comment-3", "comment-4"],
      queries: ["query-1", "query-2"],
    ...
    "p3-pmp-assessment": {
      ...
      description:
        "Review the first PMP assessment survey taken and repeat survey for revitalization results",
      status: "NOT_STARTED",
      comments: ["comment-1", "comment-2", "comment-3", "comment-4"],
      queries: ["query-1", "query-2"],
    ...
    "p3-choose-mentee": {
      ...
      description:
        "Choose a colleague to be your mentee to share Christ's Method Alone Revitalization program",
      status: "NOT_STARTED",
      comments: ["comment-1", "comment-2", "comment-3", "comment-4"],
      queries: ["query-1", "query-2"],
  ...
  comments: {
    ...
    "comment-3": {
      ...
      content:
        "No need to spend time researching this area. Focus on the other sub group.",
  ...
  queryResponses: {
    "response-1": {
      ...
      queryId: "query-2",
      content:
        "I do not have the authority to do that. Please contact Project Manager",
    ...
    "response-2": {
      ...
      queryId: "query-3",
      content:
        "The Phase 1 materials will be available by the end of this month. You will receive an email notification once they are ready.",
